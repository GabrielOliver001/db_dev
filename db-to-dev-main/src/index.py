...
#     print("Criando um novo Banco de Dados MySQL.....")
#     parametros = []
...
#     container = con.containers.run("mysql:8.4.3", detach = True, publish_all_ports = True, 
#         environment = parametros, labels={"gerador.banco": "true"})
    
#     container = con.containers.get(container.id)

#     print("Banco de Dados criado MySQL:")
#     print("---------------------------------")
...
#     print("Bancos de Dados criados MySQL:")
#     print("---------------------------------")
